...
{
    ShowExampleAppCustomRendering(&customrender);
    ...
    if (ImGui::CollapsingHeader("ShowExampleAppCustomRendering"))
    {
        ImGui::Checkbox("ShowExampleAppCustomRendering", &customrender);
    }
